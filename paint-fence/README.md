<h2>276. Paint Fence</h2><h3>Medium</h3><hr><div><p>You are painting a fence of <code>n</code> posts with <code>k</code> different colors. You must paint the posts following these rules:</p>
