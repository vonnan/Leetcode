<h2>1055. Shortest Way to Form String</h2><h3>Medium</h3><hr><div><p>From any string, we can form a <i>subsequence</i> of that string by deleting some number of characters (possibly no deletions).</p>
