<h2>644. Maximum Average Subarray II</h2><h3>Hard</h3><hr><div><p>You are given an integer array <code>nums</code> consisting of <code>n</code> elements, and an integer <code>k</code>.</p>
